/*
 * Vehicel_Behavior_Modeling_sbs.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: Vehicel_Behavior_Modeling
 * Component Simulink Path: Vehicel_Behavior_Modeling
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                Vehicel_Behavior_Modeling_sbs
...
static RegMdlInfo rtMdlInfo_Vehicel_Behavior_Modeling[1] = { "",
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("Vehicel_Behavior_Modeling");
      mxArray *rhs[3];
      char * simulinkBlockPath = getSimulinkBlockPath(S);
      if (simulinkBlockPath == NULL) {
        ssSetErrorStatus(S,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (S->mdlInfo->genericFcn != (NULL) &&
    ...
    ssRegModelRefMdlInfo(S, (char *)"Vehicel_Behavior_Modeling",
                         rtMdlInfo_Vehicel_Behavior_Modeling, 1);
  }
