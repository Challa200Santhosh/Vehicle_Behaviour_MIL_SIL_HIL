...
struct P_Vehicel_Behavior_Modeling_T_ {
  real_T BackwardSpeed_Value;          /* Expression: -1
                                        ...
                                        */
  real_T InputCarONOFF_Value;          /* Expression: 1
                                        * Referenced by: '<S1>/InputCarON//OFF'
                                        */
  real_T InputCarGears_Value;          /* Expression: 487.9901353879861
  ...
  real_T Gain3_Gain;                   /* Expression: 5
                                        ...
                                        */
  real_T InputCarAcceleration_Value;   /* Expression: 724.9011883544922
  ...
  real_T maxspeedforhandbrack_Value;   /* Expression: 10
                                        ...
                                        */
  real_T InputCarHandBreak_Value;      /* Expression: 0
  ...
  real_T Delay1_InitialCondition;      /* Expression: 0.0
                                        ...
                                        */
  real_T InputSteeringAngle_Value;     /* Expression: 532.1297819519043
